            ...
            modelBuilder.Entity("TripometerAPI.Models.Receipt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2022, 4, 8, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(4170),
                        ...
                        new
                        {
                            Id = 2,
                            AdditionalCosts = 1200,
                            Date = new DateTime(2022, 4, 8, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(5525),
                            GasStation = "Shaker",
                            PricePerGallon = 5,
                            TotalCost = 800,
                            TripId = 1
                        ...
                        new
                        {
                            Id = 3,
                            AdditionalCosts = 1200,
                            Date = new DateTime(2022, 4, 8, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(5554),
                            GasStation = "Shaker",
                            PricePerGallon = 6,
                            TotalCost = 800,
                            TripId = 1
            ...
            modelBuilder.Entity("TripometerAPI.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Distance = 200,
                            ETA = 60,
                            EmbarkDate = new DateTime(2022, 3, 25, 12, 20, 21, 178, DateTimeKind.Local).AddTicks(1622),
                            EndAddress = "Columbus",
                            EstimatedGasCost = 5,
                        ...
                        new
                        {
                            ...
                            Distance = 200,
                            ETA = 60,
                            EmbarkDate = new DateTime(2022, 4, 2, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(3470),
                            EndAddress = "Miami",
                            EstimatedGasCost = 5,
                            EstimatedTotalCost = 1000,
                            MileageAfter = 20400,
