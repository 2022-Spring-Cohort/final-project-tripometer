    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 200, 60, new DateTime(2022, 3, 26, 14, 44, 50, 271, DateTimeKind.Local).AddTicks(3550), "Columbus", 5, 1000, 20400, 20000, 1, "Cleveland", 1 },
                    { 2, null, 200, 60, new DateTime(2022, 4, 3, 14, 44, 50, 277, DateTimeKind.Local).AddTicks(6024), "Miami", 5, 1000, 20400, 20000, 1, "Shaker", 1 },
                    { 3, null, 200, 60, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Columbus", 5, 1000, 20400, 20000, 1, "Chicago", 1 },
                    { 5, null, 200, 60, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cincinnati", 5, 1000, 20400, 20000, 1, "Cleveland", 1 },
                    { 6, null, 200, 60, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cincinnati", 5, 1000, 20400, 20000, 1, "Cleveland", 1 },
                    { 7, null, 200, 60, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Columbus", 5, 1000, 20400, 20000, 1, "Chicago", 1 },
                    { 4, null, 200, 60, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "NYC", 5, 1000, 20400, 20000, 1, "Kent", 2 },
                    { 8, null, 200, 60, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Miami", 5, 1000, 20400, 20000, 1, "Shaker", 2 }
                });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 2, 1200, new DateTime(2022, 4, 9, 14, 44, 50, 278, DateTimeKind.Local).AddTicks(4936), "Shaker", 5, 800, 1 });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 3, 1200, new DateTime(2022, 4, 9, 14, 44, 50, 278, DateTimeKind.Local).AddTicks(5063), "Shaker", 6, 800, 1 });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 1, 1200, new DateTime(2022, 4, 9, 14, 44, 50, 277, DateTimeKind.Local).AddTicks(8927), "Cleveland", 4, 800, 2 });
