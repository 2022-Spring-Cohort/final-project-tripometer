    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 200, 60, new DateTime(2022, 3, 25, 12, 20, 21, 178, DateTimeKind.Local).AddTicks(1622), "Columbus", 5, 1000, 20400, 20000, 1, "Cleveland", 1 },
                    { 2, null, 200, 60, new DateTime(2022, 4, 2, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(3470), "Miami", 5, 1000, 20400, 20000, 1, "Shaker", 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, 1200, new DateTime(2022, 4, 8, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(5525), "Shaker", 5, 800, 1 });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 3, 1200, new DateTime(2022, 4, 8, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(5554), "Shaker", 6, 800, 1 });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 1, 1200, new DateTime(2022, 4, 8, 12, 20, 21, 180, DateTimeKind.Local).AddTicks(4170), "Cleveland", 4, 800, 2 });
