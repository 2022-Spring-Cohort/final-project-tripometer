    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "$2a$11$jQ1YZyvWGNd5Wq.wgNpxtej4PkzyE7aPjG./7W3qLpcZxk2BCaf1m", "TestUser1" },
                    { 2, "$2a$11$TJaqwlTvgzWizoohk.6qsupqx8ZJpjbjwgw5yPcvWKt32haSIrRWK", "TestUser2" },
                    { 3, "$2a$11$0gChnzGFC/gVLRuVC4eBJuKFI.eMCsnLYvrWSOxDoKZtlLVhPH5/i", "TestUser3" },
                    { 4, "$2a$11$f6rRfDgK241tFyCNVas8juNcVjAw3LTB0vJQP75YFvTAndbv992lS", "TestUser4" },
                    { 5, "$2a$11$OvwMrZF2TGsJf7yfa0Mvp.QW1fcM/6scMCQSigMVF8mbRpN653W/q", "TestUser5" },
                    { 6, "$2a$11$lzO2YdB5uqrb8RSj.hq2B.0nhptiY1N5meNxqjZ2do/OQB418DBa.", "TestUser6" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 200, 60, new DateTime(2022, 3, 30, 12, 0, 14, 969, DateTimeKind.Local).AddTicks(3033), "Columbus", 5, 1000, 20400, 20000, "Cleveland", 1 },
                    { 2, null, 200, 60, new DateTime(2022, 4, 7, 12, 0, 14, 971, DateTimeKind.Local).AddTicks(1422), "Miami", 5, 1000, 20400, 20000, "Shaker", 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, 1200, new DateTime(2022, 4, 13, 12, 0, 14, 971, DateTimeKind.Local).AddTicks(3452), "Shaker", 5, 800, 1 });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 3, 1200, new DateTime(2022, 4, 13, 12, 0, 14, 971, DateTimeKind.Local).AddTicks(3483), "Shaker", 6, 800, 1 });

            migrationBuilder.InsertData(
                table: "Receipts",
                columns: new[] { "Id", "AdditionalCosts", "Date", "GasStation", "PricePerGallon", "TotalCost", "TripId" },
                values: new object[] { 1, 1200, new DateTime(2022, 4, 13, 12, 0, 14, 971, DateTimeKind.Local).AddTicks(2140), "Cleveland", 4, 800, 2 });
