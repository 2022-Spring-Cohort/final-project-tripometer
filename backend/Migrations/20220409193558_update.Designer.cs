...
namespace TripometerAPI.Migrations
{
    ...
    [Migration("20220409193558_update")]
            ...
            modelBuilder.Entity("TripometerAPI.Models.Receipt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2022, 4, 9, 15, 35, 57, 599, DateTimeKind.Local).AddTicks(4218),
                        ...
                        new
                        {
                            Id = 2,
                            AdditionalCosts = 1200,
                            Date = new DateTime(2022, 4, 9, 15, 35, 57, 599, DateTimeKind.Local).AddTicks(5530),
                            GasStation = "Shaker",
                            PricePerGallon = 5,
                            TotalCost = 800,
                            TripId = 1
                        ...
                        new
                        {
                            Id = 3,
                            AdditionalCosts = 1200,
                            Date = new DateTime(2022, 4, 9, 15, 35, 57, 599, DateTimeKind.Local).AddTicks(5557),
                            GasStation = "Shaker",
                            PricePerGallon = 6,
                            TotalCost = 800,
                            TripId = 1
            ...
            modelBuilder.Entity("TripometerAPI.Models.Trip", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Distance = 200,
                            ETA = 60,
                            EmbarkDate = new DateTime(2022, 3, 26, 15, 35, 57, 597, DateTimeKind.Local).AddTicks(2079),
                            EndAddress = "Columbus",
                            EstimatedGasCost = 5,
                        ...
                        new
                        {
                            ...
                            Distance = 200,
                            ETA = 60,
                            EmbarkDate = new DateTime(2022, 4, 3, 15, 35, 57, 599, DateTimeKind.Local).AddTicks(3579),
                            EndAddress = "Miami",
                            EstimatedGasCost = 5,
                            EstimatedTotalCost = 1000,
                            MileageAfter = 20400,
